...
- Current Inventory tab supports adding, editing, and deleting inventory items with linked product, category, planned amount, actual products on hand, unit, difference/status, reorder point, location, supplier, purchase link, and notes. The Products page should show inventory at a glance so the owner can compare planned stock against actual stock without opening the full Inventory tab.
